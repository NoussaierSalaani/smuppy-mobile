/**
 * Tests for sessions/get Lambda handler
 */
...
describe('sessions/get handler', () => {
  ...
  it('should return 200 with session data', async () => {
    mockQuery.mockResolvedValueOnce({
      rows: [{
        id: SESSION_ID, status: 'confirmed', scheduled_at: new Date().toISOString(),
        duration: 30, price: '25.00', notes: null, started_at: null, ended_at: null,
        created_at: new Date().toISOString(), creator_id: 'creator-1', creator_name: 'Creator',
        creator_username: 'creator1', creator_avatar: null, creator_verified: true, creator_bio: 'Bio',
        fan_id: TEST_PROFILE_ID, fan_name: 'Fan', fan_username: 'fan1', fan_avatar: null,
        agora_channel: null,
      }],
    });
    const event = makeEvent();
