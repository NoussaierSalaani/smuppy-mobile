  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        <View style={[styles.searchBox, selectedProfession && styles.searchBoxSelected]}>
          <Ionicons 
            name={selectedProfession ? "checkmark-circle" : "search"} 
            size={22} 
            color={selectedProfession ? COLORS.primary : COLORS.grayMuted} 
          />
          <TextInput
          ...
          />
          {searchText.length > 0 && (
            <TouchableOpacity onPress={() => { setSearchText(''); setSelectedProfession(null); }}>
...
const styles = StyleSheet.create({
  ...
  searchBoxSelected: { borderColor: COLORS.primary, backgroundColor: '#F0FDF9' },
  ...
  selectedCard: { alignItems: 'center', padding: SPACING.xl, backgroundColor: '#F0FDF9', borderRadius: SIZES.radiusXl, borderWidth: 2, borderColor: COLORS.primary },
