  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {/* Intro - avec texte en gras sur certains mots */}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.textBold}>
            We strictly prohibit any content that promotes negativity, incites hatred, and/or creates anxiety.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Smuppy welcomes professional users, including fitness coaches, wellness brands, educators, and other industry experts. Professionals can share and promote their services, products, commercial content, as long as they align with Smuppy's core values.
          </Text>
          ...
          <Text style={styles.textUnderline}>
            All professional content must remain informative, ethical, and aligned with Smuppy's mission.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            To ensure a positive and inclusive experience, the following types of content are strictly prohibited:
          </Text>
          ...
          <Text style={styles.textBold}>
            Smuppy is a positive digital safe space, dedicated to physical, mental, and cultural well-being.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.textBold}>
            Every post, comment, or message must contribute to a healthy and respectful environment.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Any sanctioned user has 7 days to contest a decision by emailing [contact support]. Smuppy commits to reviewing each request within 10 business days.
          </Text>
          <Text style={styles.text}>
            Professional accounts found to repeatedly violate content guidelines may also be demonetized or restricted from promoting their services on Smuppy.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Smuppy is reserved for users 16 years and older. Any attempt to register a minor with false information will result in immediate account deletion. Parents or legal guardians may request the removal of a minor's data by sending a request to support@smuppy.com.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Smuppy reserves the right to update these guidelines to ensure a continuously healthier, professional, and positive environment. Any changes will be communicated to users.
          </Text>
        </View>
        ...
        <View style={styles.conclusionBox}>
          ...
          <Text style={styles.conclusionText}>
            Smuppy is a space for motivation, well-being, and positive exchanges. Whether you are an individual user or a professional, you contribute to building an inspiring, uplifting, and valuable community.
          </Text>
          <Text style={styles.conclusionHighlight}>
            By joining Smuppy, you become an ambassador for well-being, culture, and positivity! 🌟
          </Text>
        </View>
