    ...
    return (
      <View style={[
        ...
        {!isFromMe && (
          ...
          >
            {showAvatar && (
              <AvatarImage source={conversation.user.avatar} size={28} />
            )}
          </TouchableOpacity>
        )}
        ...
        <View style={[
          ...
          {item.type === 'image' && (
            <TouchableOpacity onPress={() => setSelectedImage(item.content)}>
              <OptimizedImage source={item.content} style={styles.messageImage} />
              {item.caption && (
          ...
          {item.type === 'link' && (
            <TouchableOpacity style={styles.linkContainer}>
              {item.preview?.image && (
                <OptimizedImage source={item.preview.image} style={styles.linkImage} />
              )}
    ...
    >
      ...
      <View style={[styles.header, { paddingTop: insets.top + 10 }]}>
        ...
        <TouchableOpacity
          ...
          onPress={() => goToUserProfile(conversation.user.id)}
        >
          <AvatarImage source={conversation.user.avatar} size={40} />
          <View>
