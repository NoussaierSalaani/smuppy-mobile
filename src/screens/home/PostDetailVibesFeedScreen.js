...
const PostDetailVibesFeedScreen = () => {
  ...
  const renderGridPost = (post, index) => {
    ...
    return (
      ...
      >
        <Image source={{ uri: post.thumbnail }} style={styles.gridThumbnail} />
      ...
      >
          ...
          <TouchableWithoutFeedback onPress={handleDoubleTap}>
            <View style={[styles.fullscreenContainer, { height: height }]}>
              ...
              {currentPost.type === 'video' ? (
                ...
                <Image source={{ uri: currentPost.media || currentPost.thumbnail }} style={styles.fullscreenMedia} />
              )}
        ...
        {viewState === VIEW_STATES.CONDENSED && (
          <View style={{ paddingTop: insets.top }}>
            ...
            >
              <Image source={{ uri: currentPost.thumbnail }} style={styles.condensedMedia} />
              <View style={styles.condensedOverlay}>
                ...
                <View style={styles.condensedInfo}>
                  <View style={styles.condensedUser}>
                    <Image source={{ uri: currentPost.user.avatar }} style={styles.condensedAvatar} />
