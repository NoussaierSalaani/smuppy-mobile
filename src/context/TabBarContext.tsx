...
/**
 * TabBar context value interface
 */
...
export function TabBarProvider({ children }: TabBarProviderProps): React.JSX.Element {
  ...
  const value: TabBarContextValue = {
    ...
    setTabBarVisible: (v: boolean) => (v ? showBars() : hideBars()),
  };
