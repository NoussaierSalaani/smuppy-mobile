...
class CognitoStorageAdapter {
  ...
  async sync(): Promise<void> {
    try {
      ...
      if (__DEV__) console.warn('[CognitoStorage] sync error:', error);
    }
  }
}
...
export async function getCognitoItem(key: string): Promise<string | null> {
  ...
  try {
    ...
    if (__DEV__) console.warn('[CognitoStorage] getItem async error:', error);
    return null;
  }
}
...
export async function setCognitoItem(key: string, value: string): Promise<void> {
  ...
  try {
    ...
    if (__DEV__) console.warn('[CognitoStorage] setItem async error:', error);
  }
}
...
export async function removeCognitoItem(key: string): Promise<void> {
  ...
  try {
    ...
    if (__DEV__) console.warn('[CognitoStorage] removeItem async error:', error);
  }
}
...
export async function clearCognitoStorage(): Promise<void> {
  ...
  try {
    ...
    if (__DEV__) console.warn('[CognitoStorage] clear async error:', error);
  }
}
