/**
 * Unblock User Handler Unit Tests
...
import { handler } from '../../profiles/unblock';
...
describe('Unblock User Handler', () => {
  ...
  describe('Happy path', () => {
    it('should return 200 with success on unblock', async () => {
    ...
    it('should execute DELETE query on blocked_users table', async () => {
    ...
    it('should use blocker_id and blocked_id columns', async () => {
      ...
      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('blocked_id'),
        expect.any(Array)
      );
    });
  });
