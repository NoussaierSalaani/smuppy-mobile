...
const FAN_POSTS = [
  ...
  },
  {
    ...
    caption: 'New personal record on the 5K! 🏃‍♂️ Been training for months and finally broke 20 minutes. Next goal: sub-19! #running #pr #goals',
    likes: 892,
    comments: 45,
    shares: 12,
    saves: 78,
  ...
  },
  {
    ...
    caption: 'Swipe to see my full yoga flow sequence 🧘‍♀️✨ Perfect for morning stretching or evening relaxation. Save this for later! #yoga #wellness #flexibility',
    likes: 2341,
    comments: 167,
    shares: 89,
    saves: 432,
  ...
  },
  {
    ...
    caption: 'Trail running is my therapy 🏔️ Nothing clears the mind like nature and fresh air. Where do you like to run?',
    likes: 567,
    comments: 34,
    shares: 8,
    saves: 45,
  ...
  },
  {
    ...
    caption: 'Full HIIT workout - no equipment needed! 🔥 20 minutes, maximum results. Drop a 💪 if you completed it!',
    likes: 4521,
    comments: 298,
    shares: 234,
    saves: 1890,
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <View key={i} style={styles.commentItem}>
              <TouchableOpacity onPress={() => {
                ...
                <Image 
                  source={{ uri: `https://i.pravatar.cc/100?img=${i + 30}` }} 
