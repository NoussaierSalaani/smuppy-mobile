...
const getStatusInfo = (colors: ThemeColors): Record<VerificationStatus, StatusInfo> => ({
  ...
  payment_required: {
    ...
    subtitle: 'Complete payment to start verification',
  },
  requires_input: {
    icon: 'document-text-outline',
    color: '#FF9800',
    title: 'Documents Needed',
    subtitle: 'Please provide your identity documents',
  },
  processing: {
...
const VERIFICATION_STEPS = [
  {
    icon: 'camera',
    title: 'Take a selfie',
    subtitle: 'We need a photo to match your ID',
  },
  {
    icon: 'id-card',
    title: 'Scan your ID',
  ...
  },
  {
    ...
    title: 'Get verified',
    subtitle: 'Receive your verified badge',
  },
];

const BENEFITS = [
  { icon: 'shield-checkmark', text: 'Verified badge on your profile' },
  { icon: 'trending-up', text: 'Increased visibility in search' },
  { icon: 'people', text: 'Build trust with your audience' },
  { icon: 'cash', text: 'Unlock monetization features' },
  { icon: 'lock-closed', text: 'Enhanced account security' },
];
...
export default function IdentityVerificationScreen() {
  ...
  const priceLabel = pricing
    ...
    : loading
      ? 'Loading price...'
      : 'Price unavailable';
  const intervalReadable = pricing?.interval || 'month';
    ...
    try {
      ...
      if (response.success && response.url) {
        ...
        if (canOpen) {
          ...
          navigation.navigate('WebView', { url: response.url, title: 'Identity Verification' });
        }
      } else {
        ...
        if (sessionResponse.success && sessionResponse.url) {
          ...
          if (canOpen) {
            ...
            navigation.navigate('WebView', { url: sessionResponse.url, title: 'Identity Verification' });
          }
        } else {
            ...
            <View style={styles.priceCard}>
              ...
              <View style={styles.priceInfo}>
                ...
                <Text style={styles.priceInfoText}>
                  Billing period: {intervalReadable}
                </Text>
              </View>
            </View>
        ...
        <View style={[styles.bottomContainer, { paddingBottom: insets.bottom + 16 }]}>
          ...
          <View style={styles.securityNote}>
            ...
            <Text style={styles.securityText}>
              Secured by Stripe Identity. Your data is encrypted and protected.
            </Text>
          </View>
        </View>
      )}
